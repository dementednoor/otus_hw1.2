...
int main(/*int argc, char const *argv[]*/)
{
    try
    {
        ...
        const auto reversed_pool = boost::adaptors::reverse(ip_pool);
        print_vector_of_addresses(reversed_pool);
        // std::cout << std::endl << "------------------------------------" << std::endl;
        const auto filtered_vector1 = filter(reversed_pool, 1);
        const auto filtered_vector2 = filter(reversed_pool, 46, 70);
        const auto filtered_vector3 = filter_any(reversed_pool, 46);
